...
from predicta_ingestion.persistence.memory import MemoryCanonicalSink, PersistResult
...
from predicta_ingestion.raw.store import FilesystemRawStore, RawStore
...
class IngestionPipeline:
    ...
    def run(self, provider: SportsProvider, request: ProviderRequest) -> IngestionReport:
        ...
        report = IngestionReport(provider=provider.name, resource=request.resource, data_mode=expected_mode)
